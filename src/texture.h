...
class checkered_texture : public texture {
    public:
        ...
        checkered_texture(double scale, const color& c1, const color& c2) : checkered_texture(scale, make_shared<solid_color>(c1), make_shared<solid_color>(c2)) {}
...
class image_texture : public texture {
    public:
        ...
        color value(double u, double v, const Point3& p) const override {
            // If we have no texture, then reutrn solid cyan
